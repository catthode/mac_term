...
1.  **Download** `Catthode.terminal` to your Mac.

2.  **Open** the Terminal app.

3.  Go to **Terminal** > **Settings...** (or press `Cmd+,`).

4.  Select the **Profiles** tab.

5.  Click the **Gear icon** (⚙️) at the bottom of the profiles list and choose **Import...**.

6.  Select the `Catthode.terminal` file you downloaded.

7.  Select **Catthode** from the list and click **Default** to make it your default profile.
